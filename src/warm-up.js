...
if (inStock < 20) {
    return console.log(shouldOrderMore, ",will have to order more")
} else {
    return console.log(false)
}
console.log(inStock) //output true, so will have to order more
...
//output: I'm going to eat some spaghetti!
...
var vegetables = ["brocoli", "carrots","snowpeas","greenbeans", "cabbage"]
...
// different fruits.
var fruits = ["tomato","mango","avocado","cherry","blueberry","apple","orange"]

// Write the code to access the 5th element of the array, using bracket notation.
console.log(fruits[4]) //if you want the #th element of an array minus by 1!
...
//any key value pairs that are related to the grocery store. numberOfShoppers = 5
var groceryStore = {
    name: "Shaws",
    isOpen: true
}
